<?php
	...
	$slider = variable_get('layerslider-slides', NULL);
				...
				<tr>
					...
					<td>
						<div class="reset-parent">
							<input id="backgroundimage-upload-add" type="text" name="background" class="ls-upload" value="">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="reset-parent">
									<input id="backgroundimage-upload-add" type="text" name="backgroundcolor" value="transparent" class="input color">
						...
						<tr>
							...
							<td>
								<div class="reset-parent">
									<input id="backgroundimage-upload" type="text" name="backgroundimage" class="input ls-upload">
									<span class="ls-reset">x</span>
								</div>
							</td>
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="reset-parent">
									<input id="yourlogo-add-new" type="text" name="yourlogo" class="input ls-upload">
									<span class="ls-reset">x</span>
								</div>
							</td>
					...
					<table>
						...
						<tbody class="ls-slide-options">
							<tr>
								...
								<td>
									<div class="reset-parent">
										<input id="backgroundimage-upload-add-tabvn" type="text" name="background" class="ls-upload" value="">
										<span class="ls-reset">x</span>
									</div>
								</td>
								<td class="right"><?php _e('Direction', 'LayerSlider') ?></td>
