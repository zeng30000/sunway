    ...
    <table>
      ...
      <tbody class="ls-slide-options">
        <tr>
          ...
          <td>
            <div class="reset-parent">
              <input id="backgroundimage-upload-edit" type="text" name="background" class="ls-upload" value="">
        ...
        <tr>
          ...
          <td colspan="5">
            <div class="reset-parent">
              <input id="myThumbnail" type="text" name="thumbnail" class="ls-upload" value="">
              <span class="ls-reset">x</span>
            </div>
          </td>
        </tr>
...
<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" class="wrap" id="ls-slider-form">
  ...
  <h2>
    ...
    <a href="<?php print url('admin/layerslider'); ?>" class="add-new-h2"><?php _e('Back to the list', 'LayerSlider') ?></a>
  </h2>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="reset-parent">
                  <input id="backgroundimage-upload-edit-new" type="text" name="backgroundcolor" value="<?php echo $slider['properties']['backgroundcolor'] ?>" class="input color">
            ...
            <tr>
              ...
              <td>
                <div class="reset-parent">
                  <input id="backgroundimage-upload" type="text" name="backgroundimage" value="<?php echo $slider['properties']['backgroundimage'] ?>" class="input ls-upload">
                  <span class="ls-reset">x</span>
                </div>
              </td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="desc"><?php _e('If enabled, LayerSlider will use relative URLs for images.', 'LayerSlider') ?></td>
            </tr>
          </tbody>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div class="reset-parent">
                  <input id="ls-your-logo" type="text" name="yourlogo" value="<?php echo $slider['properties']['yourlogo'] ?>" class="input ls-upload">
                  <span class="ls-reset">x</span>
                </div>
              </td>
              ...
              <table>
                ...
                <tbody class="ls-slide-options">
                  <tr>
                    ...
                    <td>
                      <div class="reset-parent">
                        <input id="backgroundimage-upload-new-two" type="text" name="background" class="ls-upload" value="<?php echo $layer['properties']['background'] ?>">
                        <span class="ls-reset">x</span>
                      </div>
                    </td>
                    <td class="right"><?php _e('Direction', 'LayerSlider') ?></td>
                  ...
                  <tr>
                    ...
                    <td colspan="5">
                      <div class="reset-parent">
                        <input id="layer-thumbnail-<?php print $key; ?>" type="text" name="thumbnail" class="ls-upload" value="<?php echo isset($layer['properties']['thumbnail']) ? $layer['properties']['thumbnail'] : '' ?>">
                        <span class="ls-reset">x</span>
                      </div>
                    </td>
                  </tr>
...
<script type="text/javascript">
  var pluginPath = '<?php print base_path(); ?>/layerslider/';
</script>