...
<div class="wrap">
	...
	<h2><?php _e('LayerSlider Skin Editor', 'LayerSlider') ?></h2>
	...
	<div class="ls-box ls-skin-editor-box">
		...
		<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" class="inner">
			...
			<p>
				...
				<?php _e('You need to make this file writable before you can save your changes. See the <a href="http://drupal.org/node/202483" target="_blank">Drupal docs</a> for more information.', 'LayerSlider') ?>
				<?php } else { ?>
