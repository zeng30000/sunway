  ...
  <div class="portfolio-grid">
    <ul id="thumbs">
      <?php foreach ($nodes as $node) : ?>
        ...
        ?>
        <li class="col2 item <?php print portfolio_format_terms('field_portfolio_category', $node); ?>">
          <div class="view view-tenth"> 
            ...
            <div class="mask">
             ...
             <p><?php print custom_trim_text(array('max_length' => 600, 'html' => true, 'ellipsis' => true), $node->body[LANGUAGE_NONE][0]['value']); ?></p>
